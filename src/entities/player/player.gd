...
# ===== Constants =====
const SPEED = 300.0
const PROJECTILE_SPEED = 1000.0 # Restored fast speed
const PROJECTILE_DECELERATION = 400.0
const BOUNCE_DAMPING = 0.5
const MAX_BOUNCE_FOR_PLAYER = 2

const MAX_HEALTH = 100.0
const HEALTH_DECAY_PER_SEC = 4.0
...
func _process_tongue_extend(delta: float) -> void:
	...
	# MERGED LOGIC: Enable Area collisions for Shields
	...
	if result:
		...
		# MERGED LOGIC: Check Shield Group First
...
func _launch_projectile() -> void:
	# MERGED LOGIC: "Equivalent Exchange" - Consume the host!
	if stuck_to != null:
		stuck_to.queue_free()
...
func _stick_to_prey(prey_node: Node2D) -> void:
	...
	# MERGED LOGIC: Set Zombified State (For color change)
...
func _catch_prey(prey_node: CharacterBody2D) -> void:
	...
	# MERGED LOGIC: Add collision exception so prey can be pulled to center
